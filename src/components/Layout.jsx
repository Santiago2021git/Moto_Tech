  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-gray-100">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-gray-900/80 backdrop-blur border-r border-gray-800 p-5">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-cyan-400 leading-tight">
            {empresa.nombre}
          </h1>
          <p className="text-xs text-gray-500 mt-0.5">{empresa.eslogan}</p>
        </div>
        ...
        <p className="text-xs text-gray-500">© {empresa.anioFundacion} {empresa.nombre}</p>
      </aside>
